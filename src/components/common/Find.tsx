    ...
    return (
        <div
            ...
            <div
                ...
                >
                    <p style={{ color: "#B3B3B3", fontSize: "16px", fontFamily: "MainFont", marginLeft: "8px"}}>
                    검색어를 입력해주세요.
                    </p>
                    <img
            ...
            <TagButtonList
                tags={[
                    {id:"1", content:"프로틴"},{id:"2", content:"요가"},{id:"3", content:"PT"},{id:"4", content:"필라테스"},{id:"5", content:"단백질"},{id:"6", content:"수영"},{id:"7", content:"체형교정"},{id:"8", content:"헬스장 추천"},{id:"9", content:"체력"},
                ]}
            />
            <p
                style={{
