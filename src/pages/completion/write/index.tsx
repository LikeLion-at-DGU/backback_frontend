    ...
    return (
        <ScrollContent>
            ...
            >
                ...
                <div style={{ display: 'flex', alignItems: 'center', fontFamily: 'MainFont' }}>
                    <img
                        src="../../../assets/images/Quotation_icon1.png"
                        style={{ height: '22px', width: '22px', marginBottom: '50px', marginRight: '10px' }}
                    />
                    <div style={{ textAlign: 'center' }}>
                        오운완 기록은 사진 한 장이 필수입니다.<br />
                        운동을 완료한 사진을 첨부해주세요.
                    </div>
                    <img
                        src="../../../assets/images/Quotation_icon2.png"
                        style={{ height: '22px', width: '22px', marginBottom: '50px', marginLeft: '10px' }}
                    />
                </div>
